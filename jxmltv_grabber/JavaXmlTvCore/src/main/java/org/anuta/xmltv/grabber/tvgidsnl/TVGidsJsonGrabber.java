...
public class TVGidsJsonGrabber extends AbstractGrabber {
	...
	public List<Program> getPrograms(Channel channel, Date date, int day) throws TransportException {
		...
		// They have the weirdest JSON impl ever seen...
		Type t1 = new TypeToken<Map<String, List<JsonProgram>>>() {}.getType();
		Type t2 = new TypeToken<Map<String, Map<String, JsonProgram>>>() {}.getType();
	...
	private Object escape(String titel) {
		return StringUtils.replaceEachRepeatedly(titel, 
				new String[] { " ", "&"},
				new String[] { "_", "%24"});
	}
