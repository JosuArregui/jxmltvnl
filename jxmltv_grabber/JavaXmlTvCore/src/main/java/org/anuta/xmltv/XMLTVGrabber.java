...
public class XMLTVGrabber {
    ...
    public final void grab() {
        ...
        XMLTVGrabberThreadPool threadPool = new XMLTVGrabberThreadPool(MAX_THREADS, MAX_THREADS,
                TIMEOUT, TimeUnit.SECONDS, queue, getDaysToGrab(),
                getChannels(), getFactory());
